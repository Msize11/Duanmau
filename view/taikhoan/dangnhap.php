            ...
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="view/taikhoan/dangnhap.php"><img src="../images/user-icon.png"></a></li>
            ...
            <div class="footer_logo_main">
                ...
                <div class="social_icon">
                    <ul>
                        ...
                        <li>
                            <a href="#"><img src="../view/images/youtub-icon.png"></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="footer_section_2">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="call_text"><img src="./view/images/map-icon.png"><span class="paddlin_left_0"><a href="#">London 145 United Kingdom</a></span></div>
                        <div class="call_text"><img src="./view/images/call-icon.png"><span class="paddlin_left_0"><a href="#">+7586656566</a></span></div>
                        <div class="call_text"><img src="./view/images/mail-icon.png"><span class="paddlin_left_0"><a href="#">volim@gmail.com</a></span></div>
                    </div>
                </div>
            </div>
        </div>
