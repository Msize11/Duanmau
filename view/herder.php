      ...
      <div class="header_section haeder_main">
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <span style="font-size:30px;cursor:pointer; color: #fff;" onclick="openNav()"><img src="./view/images/toggle-icon.png"></span>
               <a class="navbar-brand" href="index.html"><img src="./view/images/logo.png"></a></a>
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="view/taikhoan/dangnhap.php"><img src="./view/images/user-icon.png"></a></li>
